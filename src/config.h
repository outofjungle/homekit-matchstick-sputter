...
// Button Input
constexpr uint8_t PIN_BUTTON = 39;     // Button input (GPIO39 - input only) - Reset / AP / Factory reset
constexpr uint8_t PIN_BUTTON_ANIM = 0; // Button input (GPIO0) - Animation cycling / invert toggle
